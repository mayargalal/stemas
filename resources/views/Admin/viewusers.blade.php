            ...
            <table class="table table-striped">
                <thead>
                    ...
                    <tr>
                        ...
                        <button class="headline" style="position: relative; top:80px;">File name<th scope="col"></th>
                            </button>
                        <button class="headline" style="margin-left:8%; position: relative; top:80px;">Created By<th
                                scope="col"></th></button>
                        <button class="headline" style="margin-left:5%; position: relative; top:80px;">Last modified<th
                                scope="col"></th></button>
                    </tr>
                </thead>
                <tbody>
